...
namespace EsqueletoUsuario.Auxiliar
{
    ...
    {
        public static void DesenharEsqueletoUsuario (this SkeletonFrame quadro, 
            KinectSensor kinectSensor,  Canvas canvasParaDesenhar)
        {
            ...
            if (esqueleto != null)
            {
                ...
                {
                    esqueletoUsuarioAuxiliar.DesenharOsso(esqueleto.Joints[osso.StartJoint],
                                    esqueleto.Joints[osso.EndJoint],
                                    canvasParaDesenhar);
                    esqueletoUsuarioAuxiliar.DesenharArticulacao(esqueleto.Joints[osso.EndJoint], canvasParaDesenhar, esqueleto);
                }
            }
        }
        ...
        public static void DesenharPlanoBase(Canvas canvasParaDesenhar)
        {
